...
4. Change a file inside the folder [labs](/labs) (DONE) ✔️
...
5. If not step 3), change a file inside the folder [labs](/labs) and commit the changes into the `main` branch (DONE) ✔️
6. Go to `Actions` and see the details of your running workflow
